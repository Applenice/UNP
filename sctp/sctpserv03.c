...
int main(int argc, char **argv)
{
    ...
    Setsockopt(sock_fd, IPPROTO_SCTP, SCTP_EVENTS, &initm, sizeof(initm));
    ...
    for ( ; ; )
    {
        ...
        Sctp_sendmsg(sock_fd, readbuf, rd_sz, (struct sockaddr *)&cliaddr, len, sri.sinfo_ppid, (sri.sinfo_flags|MSG_EOF), sri.sinfo_stream, 0, 0);
    }
}
